...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-tools pull-right">
			<a href="{{ route('member.create') }}" role="button" class="btn btn-xs btn-primary"><i class="fa fa-plus"> Add New</i></a>
		</div>
	</div>
		...
		<table id="item_table" class="table table-hover table-striped">
			...
			@foreach ($items as $key => $item)
				<tr>
					...
					<td>{{ $item->name }}</td>
					<td>
						<a href="{{route('member.edit',$item->id)}}" role="button" class="btn btn-xs btn-success"><i class="icon fa fa-edit"></i> Edit</a>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<center>Anda yakin akan menghapus karyawan {{$item->name}} ?</center>
							</div>
