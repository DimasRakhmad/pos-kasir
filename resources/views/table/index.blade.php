    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="{{ route('table.create') }}" role="button" class="btn btn-xs btn-primary"><i
                            class="fa fa-plus"> Add New</i></a>
                {{--<a href="{{ url('exporttable') }}" role="button" class="btn btn-xs btn-success"><i--}}
            ...
            <table id="item_table" class="table table-hover table-striped">
                ...
                @foreach ($items as $key => $item)
                    <tr>
                        ...
                        <td>{{$item->status}}</td>
                        <td>
                            <a href="{{route('table.edit',$item->id)}}" role="button" class="btn btn-xs btn-success"><i
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <center>Anda yakin akan menghapus table {{$item->name}} ?</center>
                                </div>
