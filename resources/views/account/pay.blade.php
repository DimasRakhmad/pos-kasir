...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<form role="form" method="POST" action="{{url('pay-piutang-member-post')}}">
			{!! csrf_field() !!}
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="datepicker" name="tanggal" placeholder="Tanggal" value="{{ old('tanggal') }}" required>
			</div>
			<div class="form-group">	
				<label>Jumlah <a class="text-red">*</a></label>
				<input type="number" class="form-control" name="amount" placeholder="amount" value="{{ $total }}" required>
			</div>
