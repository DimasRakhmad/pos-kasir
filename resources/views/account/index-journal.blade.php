...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-tools pull-right">
			<a href="{{ route('transaction.create') }}" role="button" class="btn btn-xs btn-primary"><i class="fa fa-plus"> Add New</i></a>
		</div>
	</div>
		...
		<table id="item_table" class="table table-hover table-striped">
			...
			<?php $amount = 0; ?>
				<tr>
					...
					<td>
						<a href="{{route('transaction.show',$item->id)}}" role="button" class="btn btn-xs btn-primary"><i class="icon fa fa-folder"></i> Detail</a>
