...
@section('jurnal-link')class="active" @stop
@extends('app')
			...
			angular
				...
				function journalController($filter, $http, $log, $scope, Notification) {
					...
					$scope.saveJournal = function() {
						...
						$http.post('../transaction', data).then(function(success) {
							console.log(success);
							initialJournal();
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<div class="input-group">
						<input class="form-control" type="text" name="date" value="" style="text-align:center" required/>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr ng-repeat="detail in transactionDetails">
						...
						<td><input name="account_code" type="text" class="form-control" ng-model="detail.selectedAccount" uib-typeahead="account as account.code+' - '+account.name for account in getAccounts($viewValue)" required></td>
