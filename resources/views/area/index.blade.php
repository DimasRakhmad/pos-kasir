@section('area-link')class="active" @stop
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="{{ route('area.create') }}" role="button" class="btn btn-xs btn-primary"><i class="fa fa-plus">
                        Add New</i></a>
                {{--<a href="{{ url('exportarea') }}" role="button" class="btn btn-xs btn-success"><i--}}
            ...
            <table id="item_table" class="table table-hover table-striped">
                ...
                @foreach ($items as $key => $item)
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <a href="{{route('area.edit',$item->id)}}" role="button" class="btn btn-xs btn-success"><i
