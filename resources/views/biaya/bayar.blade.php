...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<form role="form" method="POST" action="{{url('bayar')}}">
			{!! csrf_field() !!}
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">	
						<select name="item[0][id_biaya]" class="form-control" id="minyak" required>
				...
				<div class="col-md-3">
					<div class="form-group">	
						...
						<input type="text" name="item[0][deskripsi]" class="form-control" required>
					</div>
				</div>

				<div class="col-md-3">
					<div class="form-group">	
						<input type="text" name="item[0][amount]" id="subtotal0" class="form-control" required>
						<input type="hidden" id="sub0" value="0">
					</div>	
				</div>
				<div class="col-md-2">
