@section('user-mgmt')class="active" @stop
@extends('app')
...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-tools pull-right">
			<a href="{{ route('user.create') }}" role="button" class="btn btn-xs btn-primary"><i class="fa fa-plus"> Add New</i></a>
			{{--<a href="{{ url('exportuser') }}" role="button" class="btn btn-xs btn-success"><i--}}
	...
	<div class="box-body">
		...
		<table class="table table-hover table-striped" id="data">
			...
			<tr>
				...
				<td>
					<a href="{{route('user.edit',$item->id)}}" role="button" class="btn btn-xs btn-success"><i class="icon fa fa-edit"></i> Edit</a>
