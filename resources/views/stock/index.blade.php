    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                ...
                {{--<a href="{{ url('exportstock') }}" role="button" class="btn btn-xs btn-success"><i--}}
            ...
            <table id="item_table" class="table table-hover table-striped">
                ...
                @foreach ($items as $key => $item)
                    ...
                    <tr>
                        ...
                        <td>{{ $amount }}</td>
                        <td>
                            <a href="{{route('stock.show',$item->id)}}" role="button" class="btn btn-xs btn-primary"><i
                                        class="icon fa fa-folder"></i> Detail</a>
