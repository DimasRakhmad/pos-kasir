...
@section('category')class="active" @stop
@extends('app')
...
<div class="box box-primary">
	<div class="box-header with-border">
		<h3 class="box-title">Daftar Category</h3>
		<div class="box-tools pull-right">
			<a href="{{ route('category.create') }}" role="button" class="btn btn-xs btn-primary"><i class="fa fa-plus"> Tambah Kategori</i></a>
			{{--<a href="{{ url('exportcategory') }}" role="button" class="btn btn-xs btn-success"><i--}}
		...
		<table id="item_table" class="table table-hover table-striped">
			...
			@foreach ($category as $item)
				...
				<tr>
					...
					<td>{{ $item->print_location }}</td>
					<td>
						<a href="{{route('category.edit',$item->id)}}" role="button" class="btn btn-xs btn-success"><i class="icon fa fa-edit"></i> Edit</a>
