    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="{{ route('menu.create') }}" role="button" class="btn btn-xs btn-primary"><i
                            class="fa fa-plus"> Tambah Menu</i></a>
                {{--<a href="{{ url('exportmenu') }}" role="button" class="btn btn-xs btn-success"><i--}}
            ...
            <table id="item_table" class="table table-hover table-striped">
                ...
                @foreach ($items as $key => $item)
                    <tr>
                        ...
                        <td>{{ $item->price }}</td>
                        <td>
                            <a href="{{route('menu.edit',$item->id)}}" role="button" class="btn btn-xs btn-success"><i
