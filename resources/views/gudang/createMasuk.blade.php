	...
	<div class="box-body">
		...
		<form role="form" method="POST" action="{{route('gudang.store')}}">
			...
			<div class="row">
				<div class="col-md-2">
					<div class="form-group">	
						<select name="id_barang[]" class="form-control select0" style="width: 100%;" id="minyak" required>
				...
				<input type="hidden" name="tipeA[]" value="Masuk">
				<div class="col-md-1">
				...
				<div class="col-md-3">
					...
					<input type="hidden" id="sub0" value=""></div>
				</div>
